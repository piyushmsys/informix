...
```
    ...
    person object which may have name,id and email as fields 
    and proto compiler will use this definition to 
...
![Protocol Buffers](/images/protocol-buffers-concepts.png)
    ...
    values from the data, check if data exists, serialize 
    data back to a file or stream, and other useful functions.
